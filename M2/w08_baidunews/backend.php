...
<head>
    ...
    <!--引入Less预处理器并导入通用及PC端Less源文件-->
    <link rel="stylesheet/less" href="css/styles_common.less">
    <link rel="stylesheet/less" href="css/styles_pc.less">
            ...
            <tbody>
                <?php
                    if (connectToDb("baidunews")) {
                        $query = mysql_query("SELECT n1.n_id, n1.n_heading, CONCAT(LEFT(n1.n_content, 10), '…') AS n_abstract, n1.insert_time, do.dno_name FROM news_main n1, d_news_origin do WHERE n1.n_origin = do.dno_id AND n1.n_status = '1' ORDER BY n1.n_id");
                    };
