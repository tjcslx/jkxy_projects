(function () {
    ...
    function getNextTenNews(startNum, category, element, trigger) {
        $.ajax({
            url: "newsint.php?heading=&abstract=&origin=0&category=" + category + "&start=" + startNum + "&num=10",
            beforeSend: function () {
    ...
    //修改段落的字体大小
    function setParaFontSize(s) {
        $("section.news>p").css("font-size", s);
    };
    ...
    $("span.big").click(function () {
        setParaFontSize("20px");
    });
    $("span.normal").click(function () {
        setParaFontSize("16px");
    });
    $("span.small").click(function () {
        setParaFontSize("12px");
    });
})()